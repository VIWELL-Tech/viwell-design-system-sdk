...
import h, { forwardRef as i, memo as d } from "react";
const f = (t, s) => /* @__PURE__ */ e("svg", { xmlns: "http://www.w3.org/2000/svg", width: 11, height: 13, fill: "none", ref: s, ...t, children: /* @__PURE__ */ e(
...
) }), p = i(f), T = d(p), _ = (t, s) => /* @__PURE__ */ e("svg", { xmlns: "http://www.w3.org/2000/svg", width: 10, height: 11, fill: "none", ref: s, ...t, children: /* @__PURE__ */ e(
  "path",
  {
    fill: "#fff",
...
) }), M = i(_), G = d(M), u = (t, s) => /* @__PURE__ */ e("svg", { xmlns: "http://www.w3.org/2000/svg", width: 14, height: 12, fill: "none", ref: s, ...t, children: /* @__PURE__ */ e(
  "path",
  {
    stroke: "#fff",
    strokeLinecap: "round",
  ...
  ({ variant: t, label: s, hasIcon: l = !1, disabled: a = !1, icon: r, ...m }) => {
    const c = w[t];
    return /* @__PURE__ */ x("button", { className: c, disabled: a, ...m, children: [
      s,
  ...
  ({ label: t, name: s, error: l = !1, errorMessage: a = "", disabled: r, ...m }) => /* @__PURE__ */ x("div", { className: "flex flex-col mb-4", children: [
    /* @__PURE__ */ e(g, { text: t, variant: "p-sm-12-m", color: r ? "grey-100" : "system-black" }),
    /* @__PURE__ */ e("input", { id: s, name: s, className: `
...
), v = () => /* @__PURE__ */ e("div", { children: "Banner" }), k = () => /* @__PURE__ */ e("div", { children: "Footer" }), C = (t, s = 16) => 1 / s * (t || 0) + "rem";
export {
  T as AppleIcon,
  E as ArrowRightIcon,
  H as Button,
  R as ButtonVariants,
  G as GoogleStoreIcon,
  B as Input,
  v as MlBanner,
  k as OrFooter,
  g as Text,
