...
import Q, { forwardRef as y, memo as x, useState as F, useCallback as O, useRef as Ze, useEffect as Le } from "react";
function _e(e, t) {
...
const yn = y(pn), Ge = x(yn), R = {
  ...
  [X.GREY_300]: "text-grey-300"
};
function W({ variant: e, color: t = "system-black", text: n, isTruncated: r = !0, ...s }) {
  const o = An(e), l = `${Cn[e] + " "}  ${kn[t] + " "} ${r ? "truncate" : ""}`;
  return /* @__PURE__ */ a(o, { className: l, ...s, children: n });
}
const ya = Q.forwardRef(
  ({
    label: e,
    name: t,
    error: n = !1,
  ...
  ${!L && p ? "text-grey-200" : "text-system-black"} `, [T, E] = F(u), Z = (A) => {
      D(!!A.target.value), m && m(A);
    }, b = O(() => {
      s || E((A) => A === "password" ? "text" : "password");
    }, [T, s]);
    return /* @__PURE__ */ a(ue, { children: /* @__PURE__ */ d("div", { className: K.container, children: [
      e && /* @__PURE__ */ a(
        W,
        {
      ...
      /* @__PURE__ */ d("div", { className: K.inputContainer, children: [
        /* @__PURE__ */ d("div", { className: `${K.inputWrapper} ${h ? K.searchInput : ""}`, children: [
          (c ?? h) && /* @__PURE__ */ a("div", { children: Q.isValidElement(c) ? c : /* @__PURE__ */ a(Ge, { "data-testid": "search-icon" }) }),
          /* @__PURE__ */ a(
            "input",
            {
              id: t,
          ...
          u === "password" ? /* @__PURE__ */ a(
            "div",
            {
              ...
              onClick: b,
              children: T === "password" ? /* @__PURE__ */ a(nn, { "data-testid": "close-eye-icon" }) : /* @__PURE__ */ a(_t, { "data-testid": "open-eye-icon" })
            }
          ) : o && Q.isValidElement(o) && /* @__PURE__ */ a("div", { className: K.rightInsideIcon, children: o })
        ] }),
        l && Q.isValidElement(l) && /* @__PURE__ */ a("div", { className: K.rightOutSideIcon, children: l })
      ] }),
      n && /* @__PURE__ */ a("span", { role: "alert", className: "text-system-red text-sm mt-1", children: /* @__PURE__ */ a(W, { text: r, variant: "p-sm-12-m", color: "system-red", isTruncated: !1 }) })
    ] }) });
  }
), K = {
  ...
  ({
    ...
    const m = Mn[r], u = c ? "top-0 pe-1 pt-1" : "", [i, f] = F(!1), h = Ze(null), g = O(() => {
      ...
      V.disabled || (o && o({ item: V, key: k }), f((T) => !T));
    }, []), D = O((k) => {
  ...
  [ve.DEFAULT]: "py-3 first:pt-0",
  [ve.SMALL]: "py-2 first:pt-0",
  [ve.LARGE]: "py-4 first:pt-0"
};
function Ln({ dataSource: e = [], bordered: t = !0, testId: n, size: r = "default", ...s }) {
  const o = Sn[r], l = t ? fe.borderedList : "";
  return /* @__PURE__ */ a("div", { ...s, children: /* @__PURE__ */ a("ul", { role: "list", "data-testid": n, children: e.length > 0 && e.map((c, m) => /* @__PURE__ */ d(
    "li",
    {
      "data-testid": `list-item-${m}`,
      className: `${o} ${fe.listItem} ${l}`,
      children: [
        /* @__PURE__ */ a("div", { "data-testid": `list-title-${m}`, className: fe.listTile, children: c.title }),
        /* @__PURE__ */ a("div", { "data-testid": `list-value-${m}`, className: fe.listValue, children: c.value })
      ]
    },
    c.id
  )) }) });
...
const fe = {
  borderedList: "border-b border-grey-50",
...
}, xa = (e, t = 16) => 1 / t * (e ?? 0) + "rem", Ue = (e) => e.length === 0 ? e : e.charAt(0).toUpperCase() + e.slice(1), Tn = (e) => e.charAt(0), va = (e) => {
  e = e.replace(/^#/, "");
  ...
  [U.Large]: "bg-grey-50 w-24 h-24 rounded-full relative flex items-center justify-center",
  [U.SMALL]: "bg-grey-50 w-[2rem] h-[2rem] rounded-full relative flex items-center justify-center",
  [U.XS]: "bg-grey-50 w-5 h-5 rounded-full relative flex items-center justify-center"
}, In = {
  [U.Large]: "text-grey-200 font-extralight text-4xl text-center",
  [U.SMALL]: "text-grey-200 font-extralight text-center",
  [U.XS]: "text-grey-200 font-extralight text-center"
}, Dn = {
  ...
  [U.XS]: "inline-flex w-5 h-5 items-center justify-center p-1"
}, Te = Ve.forwardRef(
    ...
    function f() {
      ...
      if (s && typeof s == "string") {
        const h = l ? Tn(s).toLocaleUpperCase() : s, w = {
          transform: `scale(${l ? 1 : Math.min(1, 3 / s.length)})`
        };
  ...
  ({
    ...
    return /* @__PURE__ */ d("div", { className: ge.container, children: [
      /* @__PURE__ */ a(W, { text: e, variant: "p-sm-12-m", color: s ? "grey-100" : "system-black" }),
      ...
      n && /* @__PURE__ */ a("span", { role: "alert", className: ge.error, children: /* @__PURE__ */ a(W, { text: r, variant: "p-sm-12-m", color: "system-red" }) })
    ] });
  }
), ge = {
...
function Rn({ title: e, icon: t }) {
  return /* @__PURE__ */ d("div", { className: On.container, children: [
    ...
    /* @__PURE__ */ a(W, { variant: "h4m", text: e ?? "No Data Found" })
  ] });
}
const On = {
...
function Hn({
  ...
  const h = Bn[l], g = typeof o == "object" ? o : {}, [w, p] = F(u), [L, D] = F({
    ...
    (b) => (A) => {
      p((C) => {
        const j = (C == null ? void 0 : C.order) === "asc" ? "desc" : "asc", ee = { key: b, order: j };
        return i == null || i({ sort: ee, pagination: L }), ee;
      });
    },
    [i, L]
  ), Z = (b, A) => (w == null ? void 0 : w.key) === b && w.order === A ? Se["system-black"] : Se["grey-200"];
  return /* @__PURE__ */ d("div", { className: I.outerContainer, children: [
    /* @__PURE__ */ d("table", { className: `${I.tableContainer} ${h}`, "data-testId": c, children: [
      /* @__PURE__ */ a("thead", { children: /* @__PURE__ */ a("tr", { className: I.tableHeaderRow, children: e.map((b) => {
        const C = (w == null ? void 0 : w.key) === b.key && w.order, ee = b.ellipsis && l === be.FIXED ? I.ellipsisColumn : "", xe = Ie[b.align ?? "left"];
        return /* @__PURE__ */ a(
          "th",
          {
            "data-testId": b.key,
            className: `${I.tHead} ${ee} ${xe}`,
            style: {
              width: b.width
            },
            children: b.sort ? /* @__PURE__ */ d("div", { className: I.sortColumn, children: [
              /* @__PURE__ */ a("span", { className: `${I.sortTitle} ${ee}`, children: b.title }),
              /* @__PURE__ */ d(
                "span",
                {
                  ...
                  "data-order": C,
                  children: [
                    /* @__PURE__ */ a(fn, { stroke: Z(b.key, "asc") }),
                    /* @__PURE__ */ a(bn, { stroke: Z(b.key, "desc") })
                  ]
                }
              )
            ] }) : b.title
      ...
      /* @__PURE__ */ a("tbody", { children: t.length > 0 ? t.map((b, A) => /* @__PURE__ */ a(
        "tr",
        {
          ...
          children: e.map((C) => {
            const j = b[C.dataIndex], xe = C.ellipsis && l === be.FIXED ? I.ellipsisColumn : "", ze = Ie[C.align ?? "left"];
            return /* @__PURE__ */ a("td", { className: `${I.tableData} ${xe} ${ze}`, children: C.render ? C.render(b, A) : j }, C.key);
          })
        },
        k(b, A)
    ...
    o && /* @__PURE__ */ a(Kn, { onChange: T, total: s, ...g })
  ] });
}
const I = {
  ...
  ({ name: e, title: t, disabled: n, testId: r, error: s, errorMessage: o, ...l }, c) => /* @__PURE__ */ d(ue, { children: [
    ...
    s && /* @__PURE__ */ a("span", { role: "alert", className: "text-system-red text-sm mt-1", children: /* @__PURE__ */ a(W, { text: o ?? "", variant: "p-sm-12-m", color: "system-red" }) })
  ] })
), ae = {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: Ce.labelContainer, children: [
          ...
          /* @__PURE__ */ a(W, { variant: "p-14-m", text: e })
        ] }),
...
const Ce = {
  ...
  const { variant: n = "default", footerLinkItems: r, footerDownloadLinks: s, ...o } = e, l = Fn[n], c = Wn[n], m = Yn[n], u = Vn[n];
  return /* @__PURE__ */ d(
    "footer",
    {
          ...
          return /* @__PURE__ */ d(
            "a",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ a(W, { text: i.title, variant: "p-sm-10", color: u })
              ]
            },
            i.key
          );
...
const Un = {
  ...
  return /* @__PURE__ */ a("div", { ref: t, "data-testid": s, children: /* @__PURE__ */ a("ul", { className: ke.mainContainer, children: c.map((i, f) => /* @__PURE__ */ d("li", { "data-testid": i, className: ke.breadItem, children: [
    ...
    u(f) && (Q.isValidElement(r) ? r : /* @__PURE__ */ a(je, { "data-testid": "breadcrumb-default-separator" }))
  ] }, i)) }) });
}), ke = {
  ...
  [de.NEGATIVE]: /* @__PURE__ */ a(vt, { "data-testid": "snackbar-negative-icon" })
};
function Ia({ variant: e, message: t, testId: n, isVisible: r, onReset: s }) {
  ...
  }, [r]), l ? /* @__PURE__ */ d("div", { "data-testid": `${n ?? "snackbar"}`, className: `${De.container} ${$n[e]}`, children: [
    !o && /* @__PURE__ */ a("div", { className: De.iconContainer, children: Jn[e] }),
    /* @__PURE__ */ a(W, { variant: "p-14-reg", text: t })
  ] }) : null;
}
const De = {
...
function qn({
  ...
  return /* @__PURE__ */ d("div", { className: te.mainContainer, "data-testid": n, ...c, children: [
    /* @__PURE__ */ a("div", { className: te.buttonContainer, "data-testid": "profile-CTA", children: /* @__PURE__ */ a(me, { variant: "smallStroke", label: e, hasIcon: !0, icon: t, onClick: r }) }),
    /* @__PURE__ */ a("div", { className: te.contentArea, children: /* @__PURE__ */ d("div", { className: te.content, children: [
      /* @__PURE__ */ d("div", { className: te.avatarFlex, children: [
        /* @__PURE__ */ a(Te, { size: "large", ...s }),
        !!o && /* @__PURE__ */ a("div", { className: te.userText, children: o })
      ] }),
      /* @__PURE__ */ a(Ln, { bordered: !0, size: "default", ...l })
    ] }) })
  ] });
}
const te = {
...
function Da({
  ...
  const l = Ze(null), [c, m] = F(""), u = (f) => {
    f.preventDefault(), l.current && l.current.click();
  }, i = (f) => {
    const h = f.target.files ? f.target.files[0] : null;
    h && m(URL.createObjectURL(h)), e(h);
  };
  return /* @__PURE__ */ d("div", { className: Ee.container, children: [
    /* @__PURE__ */ a(
      Te,
      {
    ...
    !!o && /* @__PURE__ */ a(W, { variant: "p-sm-10", text: String(o), color: "grey-300", isTruncated: !1 })
  ] });
}
const Ee = {
  container: "flex flex-col gap-y-3 rounded-30 h-53 w-full border-1 border-dashed justify-center items-center px-10 text-center",
  input: "hidden"
};
function Kn(e) {
  const {
    ...
    let Z = Math.max(0, g - Math.floor(c / 2));
    const b = Math.min(h, Z + c);
    b - Z < c && (Z = Math.max(0, b - c));
    const A = [];
    A.push(
      /* @__PURE__ */ a(
        "li",
    ...
    for (let C = Z + 1; C < b; C++) {
      ...
      A.push(
        /* @__PURE__ */ a(
          "li",
          {
            "data-testid": `pagination-item-${j}`,
            className: `${N.paginationItem} ${g === j ? N.activePaginationItem : "hover:bg-gray-100"}`,
            onClick: p(j),
            children: j
          },
          `pagination-item-${j}`
...
function Ea({ rows: e, isActionCTA: t, ...n }) {
  return /* @__PURE__ */ a("div", { className: S.container, ...n, children: /* @__PURE__ */ d("div", { className: S.contentContainer, children: [
    t && /* @__PURE__ */ a("div", { className: S.actionContainer, children: /* @__PURE__ */ a("div", { "data-testid": "action-button", className: S.actionButton }) }),
    /* @__PURE__ */ d("div", { className: S.content, children: [
      /* @__PURE__ */ d("div", { className: S.avatarContainer, children: [
        /* @__PURE__ */ a("div", { className: S.avatar }),
        /* @__PURE__ */ d("div", { className: S.avatarTextContainer, children: [
          /* @__PURE__ */ a("div", { className: `${S.firstTex} w-24` }),
          /* @__PURE__ */ a("div", { className: `${S.secondText} w-24` })
        ] }),
        /* @__PURE__ */ d("div", { className: S.avatarTextContainer, children: [
          /* @__PURE__ */ a("div", { className: `${S.firstTex} w-16` }),
          /* @__PURE__ */ a("div", { className: `${S.secondText} w-32` })
        ] })
      ] }),
      /* @__PURE__ */ a("div", { className: S.listContainer, children: [...Array(e ?? 7)].map((r, s) => /* @__PURE__ */ d(
        "div",
        {
          "data-testid": `list-skeleton-item-${s}`,
          className: S.listItem,
          children: [
            /* @__PURE__ */ d("div", { children: [
              /* @__PURE__ */ a("div", { className: S.listLeftFirst }),
              /* @__PURE__ */ a("div", { className: S.listLeftSecond })
            ] }),
            /* @__PURE__ */ a("div", { className: S.listRightItem })
          ]
        },
        `list-skeleton-item-${s}`
      )) })
    ] })
  ] }) });
}
const S = {
  container: "bg-system-white rounded-30 p-4",
  contentContainer: "animate-pulse",
  content: "flex flex-col gap-y-10 px-12 pt-2 pb-12",
  ...
  actionButton: "rounded-full h-10 bg-grey-50 w-32 text-end",
...
function Ra({ variant: e = "L", ...t }) {
  return /* @__PURE__ */ a(
    "div",
    {
      className: `${G.container} ${e === zn.S ? "w-96" : "w-full"}`,
      ...t,
      children: /* @__PURE__ */ d("div", { className: G.content, children: [
        /* @__PURE__ */ d("div", { className: G.memberItem, children: [
          /* @__PURE__ */ a("div", { "data-testid": "member-text", className: G.memberText }),
          /* @__PURE__ */ d("div", { className: G.flexItem, children: [
            /* @__PURE__ */ a("div", { className: `${G.firstText} w-24` }),
            /* @__PURE__ */ a("div", { className: G.secondText }),
            /* @__PURE__ */ a("div", { className: `${G.firstText} w-24` })
          ] })
        ] }),
        /* @__PURE__ */ a("div", { "data-testid": "member-bar-action-button", className: G.memberButton })
      ] })
    }
  );
}
...
function Ba({ testId: e, ...t }) {
  return /* @__PURE__ */ d("div", { "data-testid": e, className: H.container, ...t, children: [
    ...
    /* @__PURE__ */ d("div", { className: H.paginationContent, children: [
      ...
      /* @__PURE__ */ a(Ne, { "data-testid": "MenuHorizontalIcon" }),
...
function Fa({ testId: e, ...t }) {
  return /* @__PURE__ */ d("div", { className: $.container, "data-testid": e, ...t, children: [
    /* @__PURE__ */ d("div", { className: $.searchFlex, children: [
      /* @__PURE__ */ a(Ge, { fill: Se["grey-100"] }),
      /* @__PURE__ */ d("div", { className: $.flexItem, children: [
        /* @__PURE__ */ a("div", { className: `${$.firstText} w-24` }),
        /* @__PURE__ */ a("div", { className: $.secondText })
      ] })
    ] }),
    /* @__PURE__ */ d("div", { className: $.buttonFlex, children: [
      /* @__PURE__ */ a("div", { className: $.button }),
      /* @__PURE__ */ a("div", { className: $.button })
    ] })
  ] });
}
...
function he(e, t) {
  var c, m, u, i;
  const n = ye(), r = (t == null ? void 0 : t.weekStartsOn) ?? ((m = (c = t == null ? void 0 : t.locale) == null ? void 0 : c.options) == null ? void 0 : m.weekStartsOn) ?? n.weekStartsOn ?? ((i = (u = n.locale) == null ? void 0 : u.options) == null ? void 0 : i.weekStartsOn) ?? 0, s = Y(e), o = s.getDay(), l = (o < r ? 7 : 0) + o - r;
...
function Je(e) {
  const t = Y(e), n = t.getFullYear(), r = _(e, 0);
  r.setFullYear(n + 1, 0, 4), r.setHours(0, 0, 0, 0);
  const s = pe(r), o = _(e, 0);
...
const Mr = /^(\d+)(th|st|nd|rd)?/i, Nr = /\d+/i, Sr = {
  narrow: /^(b|a)/i,
...
function Yr(e) {
  const t = Y(e), n = +pe(t) - +nr(t);
  return Math.round(n / $e) + 1;
}
function qe(e, t) {
  var i, f, h, g;
  const n = Y(e), r = n.getFullYear(), s = ye(), o = (t == null ? void 0 : t.firstWeekContainsDate) ?? ((f = (i = t == null ? void 0 : t.locale) == null ? void 0 : i.options) == null ? void 0 : f.firstWeekContainsDate) ?? s.firstWeekContainsDate ?? ((g = (h = s.locale) == null ? void 0 : h.options) == null ? void 0 : g.firstWeekContainsDate) ?? 1, l = _(e, 0);
  l.setFullYear(r + 1, 0, o), l.setHours(0, 0, 0, 0);
  const c = he(l, t), m = _(e, 0);
...
function Vr(e, t) {
  var c, m, u, i;
  const n = ye(), r = (t == null ? void 0 : t.firstWeekContainsDate) ?? ((m = (c = t == null ? void 0 : t.locale) == null ? void 0 : c.options) == null ? void 0 : m.firstWeekContainsDate) ?? n.firstWeekContainsDate ?? ((i = (u = n.locale) == null ? void 0 : u.options) == null ? void 0 : i.firstWeekContainsDate) ?? 1, s = qe(e, t), o = _(e, 0);
  return o.setFullYear(s, 0, r), o.setHours(0, 0, 0, 0), he(o, t);
}
function Zr(e, t) {
  const n = Y(e), r = +he(n, t) - +Vr(n, t);
...
const J = {
  ...
  b: function(e, t, n) {
    const r = e.getHours();
    let s;
    switch (r === 12 ? s = ne.noon : r === 0 ? s = ne.midnight : s = r / 12 >= 1 ? "pm" : "am", t) {
      case "b":
      case "bb":
        return n.dayPeriod(s, {
          width: "abbreviated",
  ...
  B: function(e, t, n) {
    const r = e.getHours();
    let s;
    switch (r >= 17 ? s = ne.evening : r >= 12 ? s = ne.afternoon : r >= 4 ? s = ne.morning : s = ne.night, t) {
      case "B":
      case "BB":
      case "BBB":
        return n.dayPeriod(s, {
...
function He(e, t = "") {
  ...
  return o === 0 ? n + String(s) : n + String(s) + t + v(o, 2);
}
function Fe(e, t) {
  return e % 60 === 0 ? (e > 0 ? "-" : "+") + v(Math.abs(e) / 60, 2) : z(e, t);
}
function z(e, t = "") {
  const n = e > 0 ? "-" : "+", r = Math.abs(e), s = v(Math.trunc(r / 60), 2), o = v(r % 60, 2);
  return n + s + t + o;
}
const We = (e, t) => {
  switch (e) {
...
function Ye(e, t, n) {
  var i, f, h, g;
  const r = ye(), s = r.locale ?? Fr, o = r.firstWeekContainsDate ?? ((f = (i = r.locale) == null ? void 0 : i.options) == null ? void 0 : f.firstWeekContainsDate) ?? 1, l = r.weekStartsOn ?? ((g = (h = r.locale) == null ? void 0 : h.options) == null ? void 0 : g.weekStartsOn) ?? 0, c = Y(e);
  if (!ar(c))
  ...
  const { page: o, total: l, data: c } = e, m = [
    {
      ...
      render: (i) => /* @__PURE__ */ d("div", { className: "inline-flex items-center gap-x-2", children: [
        /* @__PURE__ */ a(Te, { src: i.logo, children: i.name, abbreviateUpper: !0 }),
    ...
    },
    {
      ...
      title: "Creation date",
      sort: !0,
      render: ({ createdAt: i }) => Ye(i || new Date(Date.now()), "dd MMM yyyy")
    },
    {
      key: "planEndDate",
      dataIndex: "planEndDate",
      title: "End date",
      render: ({ planEndDate: i }) => Ye(i || new Date(Date.now()), "dd MMM yyyy")
    },
    {
...
export {
  ...
  te as profileStyles,
  xa as pxToRem,
  Sn as sizeVariantClasses,
  we as styles,
  ie as tabStyles,
  be as tableLayouts,
  Ie as textAlignClasses,
